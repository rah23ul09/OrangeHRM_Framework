...
public class QualificationTest extends Base {
    ...
    public void SkillsValidation() {
        extentTest = extentReports.startTest("TC_021 : Validate Skills Flow");
    ...
    public void EducationValidation() {
        extentTest = extentReports.startTest("TC_022 : Validate Education Flow");
    ...
    public void LicensesValidation() {
        extentTest = extentReports.startTest("TC_023 : Validate Licenses Flow");
    ...
    public void LanguagesValidation() {
        extentTest = extentReports.startTest("TC_024 : Validate Languages Flow");
    ...
    public void MembershipsValidation() {
        extentTest = extentReports.startTest("TC_025 : Validate Memberships Flow");
